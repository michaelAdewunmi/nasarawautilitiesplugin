...
if (!$last_page_id) {
    ...
    $last_page_id = openssl_decrypt(urldecode($last_page_id), "AES-128-ECB", "SECRET");
    ...
    <div class="pagination">
        <?php if ($the_last_id_prev!=$last_data_id) : ?>
            <a class="round-btn-mtii"
                href="<?php echo site_url('user-dashboard/?mv=prev&do=approve&catg=').$biz_prem.'&gtd='
                    .urlencode(openssl_encrypt($the_last_id_prev, "AES-128-ECB", "SECRET"));?>"
            >Previous</a>
        <?php endif; ?>
        ...
        <a class="round-btn-mtii"
                href="<?php echo site_url('user-dashboard/?do=approve&catg=').$biz_prem.'&gtd='
                    .urlencode(openssl_encrypt($the_last_id, "AES-128-ECB", "SECRET"));?>"
            >Next</a>
        <?php endif; ?>
    <?php
    ?>
