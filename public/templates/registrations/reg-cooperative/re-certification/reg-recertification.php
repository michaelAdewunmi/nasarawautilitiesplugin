<?php
use MtiiUtilities\RecertificationRegistration;
$reg_util = new RecertificationRegistration;
...
elseif (isset($_REQUEST["is_new"]) && $_REQUEST["is_new"]==1) :
    ...
    <p class="dashboard-p verify-first">
        Note: Please be informed that this Registration is ONLY for organization
    ...
    <form name="" id="paymentform" action="" method="post" novalidate="novalidate">
        <label for="payee_names">Please type in Your cooperative Name</label>
                <?php $reg_util->get_input_or_placeholder_text('cooperative_name', 'text', '', '', 0, 'show-border'); ?>
        <input
