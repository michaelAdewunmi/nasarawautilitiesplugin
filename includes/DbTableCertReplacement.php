<?php
/**
 * The file to handle table creation for certificate replacements
 *
 * @category   Plugins
 ...
 * @since      1.0.0
 */
class DbTableCertReplacement extends DbTableUtilities
{
    /**
     * Get things started
     *
    ...
    */
    public function __construct()
    {
        ...
        $this->table_name  = $wpdb->prefix . 'mtii_recertification';
    ...
    */
    public function create_table()
    {
        ...
        $sql = "CREATE TABLE " . $this->table_name . " (
            ...
            name_of_society_or_organization varchar(255) NOT NULL,
            police_extract text NOT NULL,
            court_affidavit text NOT NULL,
            applicant_full_name varchar(255) NOT NULL,
            phone_number varchar(255) NOT NULL,
            email varchar(255) NOT NULL,
            user_id bigint(20) NOT NULL,
            application_date DATE NOT NULL,
            position_rank_in_the_society varchar(255) NOT NULL,
