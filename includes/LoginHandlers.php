...
class LoginHandlers
{
    ...
    /**
     * Redirect Users that are not administrators away from the admin page
     *
     * @since  1.0.0
     * @return void
     */
    public function mtii_utilities_redirect_subs_to_frontend()
    {
        ...
        if (wp_doing_ajax() && !$tasks_performer->is_mtii_admin()) {
            wp_redirect(site_url('/user-dashboard?do=profile'));
            exit;
        } else if (!wp_doing_ajax() && !in_array('administrator', $currentUser->roles)) {
            wp_redirect(site_url('/user-dashboard?do=profile'));
            exit;
        }
    }
    ...
    /**
     * Redirect Users to user-dashboard on login
     *
     * @since  1.0.0
     * @return void
     */
    public function mtii_utilities_login_redirect_userdashboard( $redirect_to, $request, $user )
    {
